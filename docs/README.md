...
This directory contains reference documentation for applying the RJW-IDD methodology.

## Where to Find Documentation

### Core Methodology

See `rjw-idd-methodology/` for the **five core METHOD files**:
...
Copy templates from `rjw-idd-methodology/templates/` when starting a project:

- **Decision Records** — `decisions/DEC-template.md`, `DEC-LITE-template.md`
- **Prototype Records** — `PROTO-template.md`
- **Agent Trust** — `AGENT-TRUST-template.md`

### Domain Extensions (Addons)

- **3D Game Core** — `rjw-idd-methodology/addons/3d-game-core/`
- **Video AI Enhancer** — `rjw-idd-methodology/addons/video-ai-enhancer/`
