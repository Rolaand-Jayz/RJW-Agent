...
class OpenAIProvider(LLMProvider):
    ...
    def generate_json(self, prompt: str, schema: dict) -> dict:
        ...
        # Note: response_format enforces JSON output but does not validate against the schema.
        # The schema in the prompt is only a hint for the model, not enforced by the API.
